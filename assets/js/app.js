...
xText
  .append("text")
  .attr("y", -26)
  .attr("data-name", "Loud talking/Disruptive behavior")
  .attr("data-axis", "x")
  .attr("class", "aText active x")
  .text("Loud talking/Disruptive behavior");
// 2. Age
xText
  .append("text")
  .attr("y", 0)
  .attr("data-name", "Use of Library other than intended purpose")
  .attr("data-axis", "x")
  .attr("class", "aText inactive x")
  .text("Use of Library other than intended purpose");
// 3. Income
xText
  .append("text")
  .attr("y", 26)
  .attr("data-name", "Theft/Destruction of materials or property")
  .attr("data-axis", "x")
  .attr("class", "aText inactive x")
  .text("Theft/Destruction of materials or property");

// xText
//   .append("text")
//   .attr("y", 52)
//   .attr("data-name", "Interference with other customers or staff")
//   .attr("data-axis", "x")
//   .attr("class", "aText inactive x")
//   .text("Interference with other customers or staff");
...
yText
  .append("text")
  .attr("y", -26)
  .attr("data-name", "Violation of law or Library policy")
  .attr("data-axis", "y")
  .attr("class", "aText active y")
  .text("Violation of law or Library policy");

// 2. Smokes
yText
  .append("text")
  .attr("x", 0)
  .attr("data-name", "Offensive/threatening gestures or language")
  .attr("data-axis", "y")
  .attr("class", "aText inactive y")
  .text("Offensive/threatening gestures or language");

// 3. Lacks Healthcare
yText
  .append("text")
  .attr("y", 26)
  .attr("data-name", "Sexual misconduct")
  .attr("data-axis", "y")
  .attr("class", "aText inactive y")
...
function visualize(theData) {
  ...
  var curX = "Loud talking/Disruptive behavior";
  var curY = "Violation of law or Library policy";
  ...
  var toolTip = d3
    ...
    .html(function(d) {
      ...
      var theX;
      // Grab the state name.
      var theState = "<div>" + d.month + "</div>";
      // Snatch the y value's key and value.
      var theY = "<div>" + curY + ": " + d[curY] + "</div>";
      // If the x key is poverty
      if (curX === "Loud talking/Disruptive behavior") {
  ...
  theCircles
    ...
    .on("mouseout", function(d) {
      ...
      toolTip.hide(d);
      // Remove highlight
      d3.select("." + d.abr).style("stroke", "#e3e3e3");
    });
